...
public class CameraController : MonoBehaviour {
	...
	private void Input() {
		_mouseMovement.x += UnityEngine.Input.GetAxisRaw(MouseX) * mouseSensitivityX * Time.deltaTime;
		_mouseMovement.y -= UnityEngine.Input.GetAxisRaw(MouseY) * mouseSensitivityY * Time.deltaTime;
	...
	private void OnDrawGizmos() {
		...
		Gizmos.DrawWireSphere(_cameraPos, _cameraCollisionRadius);
